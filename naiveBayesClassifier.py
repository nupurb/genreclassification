...
Genres = ["american",  "classic pop and rock",  "electronic", "european", "folk", 
	"hip hop rnb and dance hall", "metal", "pop and chart", "production music",
	"rock", "rock and indie"]

base = "singlegenretrain/"
p = Pool()
for i in Genres:
    p.learn(base + i, i)
...
base = "singlegenretest/"
for i in Genres:
    print("Testing genre " + i)
